...
RcppExport SEXP _coverr_constructIsoAlignedLevelSets(SEXP xSEXP, SEXP bndsSEXP, SEXP save_boundsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_coverr_constructIsoAlignedLevelSets", (DL_FUNC) &_coverr_constructIsoAlignedLevelSets, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_coverr(DllInfo *dll) {
